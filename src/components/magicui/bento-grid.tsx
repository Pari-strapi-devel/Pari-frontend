    ...
    >
      ...
      <div className="relative flex flex-col w-full pt-2 h-[380px] z-10 bg-white dark:bg-popover">
        <div className="px-6 py-6 w-full">
          <div className={`flex flex-col gap-1 ${currentLocale === 'ur' ? 'md:h-[180px] h-[180px]' : 'md:h-[150px] h-[150px]'}`}>
            <h3 className="  h-20 flex  text-[26px] font-bold leading-[136%] tracking-[-0.04em]  text-foreground  !line-clamp-2">
              {title}
            </h3>
