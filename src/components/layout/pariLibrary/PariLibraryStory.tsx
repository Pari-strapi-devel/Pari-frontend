...
export function PariLibraryStory() {
  ...
  return (
    <div className="overflow-hidden rounded-md pb-20">
      <div className="px-2">
        

        <div className="relative  overflow-visible">
          <div ref={sliderRef} className="keen-slider border-b-1 pb-20 dark:border-gray-800  max-w-[1232px] mx-auto relative !overflow-visible">
